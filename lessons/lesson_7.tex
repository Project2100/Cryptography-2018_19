...
\begin{proof}
    ...
    \begin{cryptogame}
        ...
        \receive{\shortstack[l]{
            ...
            $z = f_k(r) = G_{r_0}(f'_k(r_{1 \dots n}))$
        }}{$z$}{}
    ...
    \begin{cryptogame}
        ...
        \receive{\shortstack[l]{
            ...
            $z = G_{r_0}(\overline{R}(r_{1 \dots n}))$
        }}{$z$}{}
    ...
    \begin{proof}
        ...
        \begin{cryptoredux}
            ...
            \cseqchallenger{\shortstack[l]{
                ...
                $\overline{R} \pickUAR \R(n - 1, \lambda)$ \\
                $b \pickUAR \binary$
            }}
            ...
            \invoke{\shortstack[l]{
                $y_b = f_k(r_0, z_b)$  % AP190909 - IMPORTANT : Make a note here: y is either f_k or RcircG
            }}{$y_b$}{}
    ...
    Before tackling the reduction of the last two hybrids, it is best to introduce another lemma:
    ...
    \begin{lemma}
        $\hybridg{1}[\overline{R} \circ G](\lambda) \compindist \hybridg{2}[R](\lambda)$       
    \end{lemma}
    ...
    \begin{proof}
        ...
        Notes: The game could look like this:

        but it cannot work: there is no way to pass the 'r' information to the challenger in the prg game. Also, k stays the same in all iterations, as is specified in the PRF game, whereas in the original prg game adapted to the lemma, k is picked UAR on each iteration.
        Therefore, a consideration regarding the computation path in the tree must be done.
